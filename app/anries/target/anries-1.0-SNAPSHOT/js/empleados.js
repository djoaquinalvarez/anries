...
function editarLocalidad(evento) {
    ...
    var fila = document.querySelector("#empleado_" + evento.target.id.substring(14,));
    console.log("#empleado_" + evento.target.id.substring(14,));
    ...
    var form = document.querySelector("#formulario-empleados");
    form.action = "/anries/form_modificar-empleado";
...
function cancelarEdicion() {
    ...
    document.querySelector("#formulario-empleados").reset();
