...
@WebServlet("/form_modificar-cliente")
public class ServletModificarCliente extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (errores.isEmpty()) {
            try{
                modificar(Integer.valueOf(idCliente), nombre, apellido, direccion, Integer.valueOf(dni), fechaNacimiento, Integer.valueOf(numeroTelefono), nombreLocalidad);
                mensajeConfirmacion = "Los datos del cliente han sido modificados correctamente.";
    ...
    public void modificar(Integer idCliente, String nombre, String apellido, String direccion, Integer dni, String fechaNacimiento, Integer numeroTelefono, String nombreLocalidad) throws Exception {
        Cliente.modificar(idCliente, nombre, apellido, direccion, dni, fechaNacimiento, numeroTelefono, nombreLocalidad);
    }
}
