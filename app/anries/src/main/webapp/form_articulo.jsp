    ...
    <div class="d-flex flex-row ms-5 me-5">
        <form action="/anries/form_registro-articulo" id="formulario-articulos" method="post" class="w-50 d-inline-block">
            ...
            <div class="mb-4 ms-4">
                ...
                <label for="marca" class="form-label"><b>Localidad</b></label>
                <select id="marca" name="marca" class="form-select w-75 mb-3 dato-formulario" aria-label="Default select example">
                    ...
                    for(Marca marca: marcas) { %>
                        <option value="<%=marca.getNombre()%>" id="<%=marca.getId()%>"><%=marca.getNombre()%></option>
                    <%}%>
                </select>
                ...
                <input type="tel" name="precioPorUnidad" id="precioPorUnidad" class="form-control w-75 mb-3 dato-formulario" placeholder="Inserte el precio por unidad del articulo" value="${param.precioPorUnidad}">
                <%
                ...
                <input type="date" name="minimaCantidadStock" id="minimaCantidadStock" class="form-control w-75 mb-3 dato-formulario" placeholder="Inserte la cantidad minima de stock" value="${param.cantidadMinimaStock}">
                <%
